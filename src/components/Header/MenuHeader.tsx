...
export default function MenuHeader() {
  ...
  return (
    <motion.div animate={{
      ...
      transition={{ duration: 0.3 }} className="z-100000 bg-[#ffffffdd] backdrop-blur-sm fixed top-32 w-full border-b border-t border-b-neutral-300 border-t-neutral-300">
